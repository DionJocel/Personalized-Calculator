...
<body>
    ...
    <form action="tenorioMultiplication.php" method="POST">
        <table>
            <tr>
            ...
            <tr>
                <td><label for="tenorioProduct">The product of the two number is: </label></td>
                <td><input type="number" id="tenorioProduct"></td>
            </tr>
        </table>
    </form>
